...
function Userdashboard() {
  ...
  return (
    <div className="p-4 relative">
      {/* Header */}
      <div className="bg-blue-800 text-white px-6 py-4 rounded-md mb-6 shadow-md flex justify-between items-center relative">
        {/* Left Navigation */}
  ...
  <div
    key={prod._id}
    className="border border-gray-300 p-4 rounded shadow-md hover:shadow-lg transition"
  >
    <img
